...
import { fromDatabaseVehicle, sampleVehicles, toDatabaseVehicle, validateVehicle } from './vehicleModel'
...
describe('vehicle validation', () => {
  ...
  it('preserves a vehicle photo through database mapping', () => {
    ...
    expect(fromDatabaseVehicle({ ...row, id: 'vehicle-1' }).photoUrl).toBe('/vehicles/double-2015.jpg')
  })
})
